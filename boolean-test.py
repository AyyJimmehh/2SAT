...
def test_assign2():
    ...
    s = a['s']
    t = a['t']
    assert (((not p) or q) and ((not q) or r) and ((not q) or t) and ((not q) or s) and ((not t) or s) and (
                not s or not p))
...
def test_assign3():
    ...
    q = a['q']
    r = a['r']
    assert (((not p) or q) and ((not p) or r) and ((not q) or r) and (p or (not q)) and (not p or not q) and (
                not p or not r))
